...
#SUBLEVEL = 4
#
# I add the supporting of tftp, so 
# I change the sublevel to 5
#
SUBLEVEL = 5
...
#ARM_GCC_LIBS	= /opt/eldk/arm/lib

OBJCOPYFLAGS = -R .comment -R .stab -R .stabstr

CLIBS = -L$(ARM_GCC_LIBS) -lc -lgcc 

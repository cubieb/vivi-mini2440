 ...
 *
 * $Id: smc_core_2440.c,v 1.1.1.1 2004/02/04 06:22:25 laputa Exp $
 *
 *
 */
...
//	printk(" NFSTAT 0x%08X , NFCONF 0x%08X NFCONT 0x%08X \n",NFSTAT,NFCONF,NFCONT);
	/* Send the command for reading device ID */
	nand_command(mtd, NAND_CMD_READID, 0x00, -1);

//	this->wait_for_ready();
	for (i = 0; i < 100;i++);
//	printk("NFCMD 0x%08X NFADDR 0x%08X \n",NFCMD,NFADDR);
//	printk(" NFSTAT 0x%08X , NFCONF 0x%08X NFCONT 0x%08X \n",NFSTAT,NFCONF,NFCONT);

...
#ifdef CONFIG_SA1100_ENDA_MEM_SIZE
#define FLASH_SIZE		CONFIG_SA1100_ENDA_FLASH_SIZE
#else
...
#ifdef CONFIG_SA1100_ENDA_MEM_SIZE
#define DRAM_SIZE		CONFIG_SA1100_ENDA_RAM_SIZE
#else
...
/*
 */
#ifdef CONFIG_SA1100_ENDA_HALFMEMCLK
...
#elif DRAM_SIZE == SZ_16M
#define DRAM_MDCNFG		DRAM_MDCNFG_16MB
#else
#error not define DRAM_SIZE
#endif
#define DRAM_CAS0_WAVEFORM0	0x55555557
#define DRAM_CAS0_WAVEFORM1	0x55555555
#define DRAM_CAS0_WAVEFORM2	0x55555555
#define DRAM_MDREFR_32MB	(MDREFR_TRASR(1) | MDREFR_DRI(512) | \
				MDREFR_E1PIN | MDREFR_K1RUN | MDREFR_K1DB2 | \
				MDREFR_EAPD | MDREFR_KAPD)
#define DRAM_MDREFR_16MB	(MDREFR_TRASR(1) | MDREFR_DRI(2048) | \
				MDREFR_E1PIN | MDREFR_K1RUN | MDREFR_K1DB2 | \
				MDREFR_EAPD | MDREFR_KAPD)
#if DRAM_SIZE == SZ_32M
#define DRAM_MDREFR		DRAM_MDREFR_32MB
#elif DRAM_SIZE == SZ_16M
#define DRAM_MDREFR		DRAM_MDREFR_16MB
#else
#error not define DRAM_SIZE
#endif
#define MSC0_CONFIG_32MB	(MSC_RT_BURST8 | MSC_RBW32 | \
				MSC_RDF(31) | MSC_RDN(31) | MSC_RRR(31))
#define MSC0_CONFIG_16MB	(MSC_RT_BURST8 | MSC_RBW32 | \
				MSC_RDF(31) | MSC_RDN(31) | MSC_RRR(31))
#if DRAM_SIZE == SZ_32M
#define MSC0_CONFIG		MSC0_CONFIG_32MB
#elif DRAM_SIZE == SZ_16M
#define MSC0_CONFIG		MSC0_CONFIG_16MB
#else
#error not define DRAM_SIZE
#endif
...
#define DRAM_MDCNFG_32MB	(MDCNFG_BANK0_ENABLE | MDCNFG_DTIM0_SDRAM | \
				...
				MDCNFG_TRP0(2) | MDCNFG_TDL0(3) | MDCNFG_TWR0(3))
#define DRAM_MDCNFG_16MB	(MDCNFG_BANK0_ENABLE | MDCNFG_DTIM0_SDRAM | \
       				MDCNFG_DWID0_32B | MDCNFG_DRAC0(4) | \
...
#define DRAM_MDREFR_16MB	(MDREFR_TRASR(1) | MDREFR_DRI(2048) | \
				MDREFR_E1PIN | MDREFR_K1RUN | \
				MDREFR_EAPD | MDREFR_KAPD)
#define MSC0_CONFIG_32M		(MSC_RT_BURST8 | MSC_RBW32 | \
				MSC_RDF(14) | MSC_RDN(4) | MSC_RRR(2))
#define MSC0_CONFIG_16M		(MSC_RT_BURST8 | MSC_RBW32 | \
				MSC_RDF(14) | MSC_RDN(4) | MSC_RRR(2))
#if DRAM_SIZE == SZ_32M
#define MSC0_CONFIG		MSC0_CONFIG_32MB
#elif DRAM_SIZE == SZ_16M
